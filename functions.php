...
//Register hook to load ajax movie script
add_action('wp_enqueue_scripts', 'ajax_movie_load_scripts');

//Add movie search ajax jquery file
function ajax_movie_load_scripts(){
